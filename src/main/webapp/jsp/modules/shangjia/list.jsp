...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shangpubianhaoSearch" class="form-control form-control-sm" placeholder="请输入商铺编号" aria-controls="tableId">
									<label>
										商铺名称
									</label>
									<input type="text" id="shangpumingchengSearch" class="form-control form-control-sm" placeholder="请输入商铺名称" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yingyezhenghao')">营业证号<i id="yingyezhenghaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jingyingfanwei')">经营范围<i id="jingyingfanweiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#shangpubianhaoSearch').val() != null && $('#shangpubianhaoSearch').val() != ''){
				searchForm.shangpubianhao ="%" +  $('#shangpubianhaoSearch').val() + "%";
			}
			
			if($('#shangpumingchengSearch').val() != null && $('#shangpumingchengSearch').val() != ''){
				searchForm.shangpumingcheng ="%" +  $('#shangpumingchengSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("shangjia/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				shangpubianhao : searchForm.shangpubianhao,	
				shangpumingcheng : searchForm.shangpumingcheng,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var yingyezhenghaoCell  = document.createElement('td');

						 yingyezhenghaoCell.innerHTML = item.yingyezhenghao;

			row.appendChild(yingyezhenghaoCell);
			var jingyingfanweiCell  = document.createElement('td');

						 jingyingfanweiCell.innerHTML = item.jingyingfanwei;

			row.appendChild(jingyingfanweiCell);
