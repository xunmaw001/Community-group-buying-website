...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>营业证号</label>
										<input name="yingyezhenghao" id="yingyezhenghao" name="yingyezhenghao" class="form-control" placeholder="营业证号">
									</div>
									<div class="form-group col-md-6">
										<label>经营范围</label>
										<input name="jingyingfanwei" id="jingyingfanwei" name="jingyingfanwei" class="form-control" placeholder="经营范围">
									</div>
									<div class="form-group col-md-6">
										<label>负责人</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#yingyezhenghao").val(ruleForm.yingyezhenghao);	
			$("#jingyingfanwei").val(ruleForm.jingyingfanwei);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yingyezhenghao != null && res.data.yingyezhenghao != ''){

						$("#yingyezhenghao").val(res.data.yingyezhenghao);
						$("#yingyezhenghao").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.jingyingfanwei != null && res.data.jingyingfanwei != ''){

						$("#jingyingfanwei").val(res.data.jingyingfanwei);
						$("#jingyingfanwei").attr('readonly','readonly');
					}
