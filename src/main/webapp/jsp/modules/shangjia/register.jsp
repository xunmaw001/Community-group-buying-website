	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">商铺编号</label> 
							<input  name="shangpubianhao" placeholder="商铺编号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">商铺名称</label> 
							<input  name="shangpumingcheng" placeholder="商铺名称" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">营业证号</label> 
							<input  name="yingyezhenghao" placeholder="营业证号" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">经营范围</label> 
							<input  name="jingyingfanwei" placeholder="经营范围" class="form-control-i">
							</div>
							<div class="form-group">
