						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="tuichushijian" name="tuichushijian" class="form-control" v-model="ruleForm.tuichushijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>退出原因</label>

									<input id="tuichuyuanyin" name="tuichuyuanyin" class="form-control" v-model="ruleForm.tuichuyuanyin" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>账号</label>
