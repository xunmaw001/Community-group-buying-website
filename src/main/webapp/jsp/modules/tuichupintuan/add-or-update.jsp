		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑退出拼团</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>退出拼团管理</span></li>
								<li class="breadcrumb-item active"><span>编辑退出拼团</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">退出拼团信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>退出时间</label>
										<div id="tuichushijianDate" class="input-append date form_datetime">
											<input id="tuichushijian-input" name="tuichushijian" size="15" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>退出原因</label>
										<input name="tuichuyuanyin" id="tuichuyuanyin" name="tuichuyuanyin" class="form-control" placeholder="退出原因">
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tuichupintuan/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("tuichupintuan/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("tuichupintuan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tuichupintuan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#tuichushijian-input").val(getCurDate());
			$("#tuichushijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function calculationSE(colName){
			//单列求和接口
			http("tuichupintuan"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#tuichushijian-input").val(ruleForm.tuichushijian);
			$("#tuichuyuanyin").val(ruleForm.tuichuyuanyin);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tuichushijian != null && res.data.tuichushijian != ''){

						$("#tuichushijian-input").val(res.data.tuichushijian);
						$('#tuichushijianFileName').val(res.data.tuichushijian)
					}
					if(res.data != null && res.data != '' && res.data.tuichuyuanyin != null && res.data.tuichuyuanyin != ''){

						$("#tuichuyuanyin").val(res.data.tuichuyuanyin);
						$("#tuichuyuanyin").attr('readonly','readonly');
					}
