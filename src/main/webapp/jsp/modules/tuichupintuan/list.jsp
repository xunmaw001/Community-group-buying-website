...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">退出拼团管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>退出拼团列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">退出拼团列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('tuichushijian')">退出时间<i id="tuichushijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('tuichuyuanyin')">退出原因<i id="tuichuyuanyinIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tuichushijianCell  = document.createElement('td');

						  tuichushijianCell.innerHTML = item.tuichushijian;


			row.appendChild(tuichushijianCell);
			var tuichuyuanyinCell  = document.createElement('td');

						 tuichuyuanyinCell.innerHTML = item.tuichuyuanyin;

			row.appendChild(tuichuyuanyinCell);
		...
		function sh(){
			...
			httpJson("tuichupintuan/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tuichupintuan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"tuichupintuan");
