		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑拼团申请</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>拼团申请管理</span></li>
								<li class="breadcrumb-item active"><span>编辑拼团申请</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">拼团申请信息</h3>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "pintuanshenqing/info/" + id,
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				if(crossFlag) {
					if(Number($('#pintuanrenshu').val())<1) {
						alert('请输入正确的拼团人数');
						return false;
					}
					if(Number(pintuanrenshuKucun) < Number($('#pintuanrenshu').val())){
						alert('拼团人数不能大于'+pintuanrenshuKucun+'！请重新输入');
						return false;
					}
				}
				let data = {};
				...
				if(crossrefid && crossuserid) {
					...
					http("pintuanshenqing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("pintuanshenqing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("pintuanshenqing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("pintuanshenqing"+colName,"GET",{
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.pintuanrenshu != null && res.data.pintuanrenshu != ''){
						...
						pintuanrenshuKucun = res.data.pintuanrenshu;
		...
		function crossTableUpdate(){
			...
			if(flag){
				httpJson(crossTableName + "/update","POST",{
					id: crossTableId,
					pintuanrenshu: Number(crossRuleForm.pintuanrenshu) - Number($('#pintuanrenshu').val()),	
				},(res)=>{
					if(res.code == 0){
						console.log('跨表更新成功');
						return true;
