		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑团购订单</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>团购订单管理</span></li>
								<li class="breadcrumb-item active"><span>编辑团购订单</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">团购订单信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>拼团进度</label>
										<input name="pintuanjindu" id="pintuanjindu" name="pintuanjindu" class="form-control" placeholder="拼团进度">
									</div>
									<div class="form-group col-md-6">
										<label>订单状态</label>
										<select id="dingdanzhuangtaiSelect" name="dingdanzhuangtai" class="form-control">
												<option value=""></option>
												<option class="dingdanzhuangtaiOption" value="发货中">
													发货中
												</option>
												<option class="dingdanzhuangtaiOption" value="未发货">
													未发货
												</option>
												<option class="dingdanzhuangtaiOption" value="已接收">
													已接收
												</option>
										</select>	
									</div>	
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tuangoudingdan/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("tuangoudingdan/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("tuangoudingdan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tuangoudingdan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("tuangoudingdan"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#pintuanjindu").val(ruleForm.pintuanjindu);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.pintuanjindu != null && res.data.pintuanjindu != ''){

						$("#pintuanjindu").val(res.data.pintuanjindu);
						$("#pintuanjindu").attr('readonly','readonly');
					}
