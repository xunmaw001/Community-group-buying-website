...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">团购订单管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>团购订单列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">团购订单列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('pintuanjindu')">拼团进度<i id="pintuanjinduIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('dingdanzhuangtai')">订单状态<i id="dingdanzhuangtaiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var pintuanjinduCell  = document.createElement('td');

						 pintuanjinduCell.innerHTML = item.pintuanjindu;

			row.appendChild(pintuanjinduCell);
			var dingdanzhuangtaiCell  = document.createElement('td');

						  dingdanzhuangtaiCell.innerHTML = item.dingdanzhuangtai; 

			row.appendChild(dingdanzhuangtaiCell);
		...
		function sh(){
			...
			httpJson("tuangoudingdan/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tuangoudingdan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"tuangoudingdan");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"tuangoudingdan");
