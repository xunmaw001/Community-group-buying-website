						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="pintuanjindu" name="pintuanjindu" class="form-control" v-model="ruleForm.pintuanjindu" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>订单状态</label>

									<input id="dingdanzhuangtai" name="dingdanzhuangtai" class="form-control" v-model="ruleForm.dingdanzhuangtai" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>账号</label>
