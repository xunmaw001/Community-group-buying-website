	...
	<body>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
						  ...
						  carousel.render({
							...
							width: '100%',
						  	...
						  	indicator: 'inside'
                                ...
                                jquery('#shenqingshijian').val(getCurDate());
				laydate.render({
				...
				vue.detail.pintuanrenshu = 0
				vue.ro.pintuanrenshu = false;
				...
				form.on('submit(*)', function(data) {
					...
					// 跨表计算判断
                    var obj = JSON.parse(localStorage.getItem('crossObj'));
                    obj.pintuanrenshu = obj.pintuanrenshu - data.pintuanrenshu
                    if(obj.pintuanrenshu<0){
                        layer.msg(`拼团人数不足`, {
					 		time: 2000,
					 		icon: 5
					 	});
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('pintuanshenqing/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            obj.pintuanrenshu = parseFloat(obj.pintuanrenshu) - parseFloat(data.pintuanrenshu)

                                            http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                                            // 提交数据
                                            http.requestJson('pintuanshenqing' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
