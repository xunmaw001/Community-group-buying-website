			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.youhuijia" type="text" :readonly="ro.youhuijia" name="youhuijia" id="youhuijia" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">拼团人数：</label>
						<div class="layui-input-block">
							<input v-model="detail.pintuanrenshu" type="text" :readonly="ro.pintuanrenshu" name="pintuanrenshu" id="pintuanrenshu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="xiangqingmiaoshu" id="xiangqingmiaoshu">请输入详情描述</textarea>
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='youhuijia'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.youhuijia = true;
                                                continue;
                                        }
                                        if(o=='pintuanrenshu'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.pintuanrenshu = true;
                                                continue;
                                        }
                                        if(o=='xiangqingmiaoshu'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.xiangqingmiaoshu = true;
                                                continue;
                                        }
                                        if(o=='shangpubianhao'){
                                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
					...
					var xiangqingmiaoshu = tinymce.get('#xiangqingmiaoshu').getContent()
					data.xiangqingmiaoshu = xiangqingmiaoshu;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('tuangouxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('tuangouxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
