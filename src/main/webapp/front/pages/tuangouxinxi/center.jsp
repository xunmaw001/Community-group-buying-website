			...
			<div class="center-container">
				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px #D4E8D3","margin":"0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">商品类型</label>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">商品数量</label>
							<div class="layui-input-block input">
								<input type="text"  name="shangpinshuliang" name="shangpinshuliang" id="shangpinshuliang" placeholder="商品数量" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">优惠价</label>
							<div class="layui-input-block input">
								<input type="text"  name="youhuijia" name="youhuijia" id="youhuijia" placeholder="优惠价" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">拼团人数</label>
							<div class="layui-input-block input">
								<input type="text"  name="pintuanrenshu" name="pintuanrenshu" id="pintuanrenshu" placeholder="拼团人数" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">商铺编号</label>
							<div class="layui-input-block input">
								<input type="text"  name="shangpubianhao" name="shangpubianhao" id="shangpubianhao" placeholder="商铺编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">商铺名称</label>
							<div class="layui-input-block input">
								<input type="text"  name="shangpumingcheng" name="shangpumingcheng" id="shangpumingcheng" placeholder="商铺名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block">
								<img id="shangpintupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"0 0 6px #8eb6a0","borderColor":"rgba(142, 182, 160, 1)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","width":"80px","borderStyle":"solid","height":"80px"}' src="../../img/avator.png">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block">
								<button :style='{"padding":"0 10px","boxShadow":"0 0 6px #8eb6a0","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(142, 182, 160, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="shangpintupianUpload">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function() {
				...
				form.on('submit(*)', function(data) {
				    ...
				    if(!isIntNumer(data.pintuanrenshu)){
					layer.msg('拼团人数应输入整数', {
									time: 2000,
									icon: 5
								});
