					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block input">
								<input type="text" readonly="readonly" name="shangpubianhao" name="shangpubianhao" id="shangpubianhao" placeholder="商铺编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">营业证号</label>
							<div class="layui-input-block input">
								<input type="text"  name="yingyezhenghao" name="yingyezhenghao" id="yingyezhenghao" placeholder="营业证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">经营范围</label>
							<div class="layui-input-block input">
								<input type="text"  name="jingyingfanwei" name="jingyingfanwei" id="jingyingfanwei" placeholder="经营范围" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
