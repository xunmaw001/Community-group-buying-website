			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.yingyezhenghao" type="text" :readonly="ro.yingyezhenghao" name="yingyezhenghao" id="yingyezhenghao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">经营范围：</label>
						<div class="layui-input-block">
							<input v-model="detail.jingyingfanwei" type="text" :readonly="ro.jingyingfanwei" name="jingyingfanwei" id="jingyingfanwei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
