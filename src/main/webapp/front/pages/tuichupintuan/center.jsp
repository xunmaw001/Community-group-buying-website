			...
			<div class="center-container">
				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px #D4E8D3","margin":"0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">退出时间</label>
							<div class="layui-input-block date">
								<input type="text" name="tuichushijian" id="tuichushijian" placeholder="退出时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">退出原因</label>
							<div class="layui-input-block input">
								<input type="text"  name="tuichuyuanyin" name="tuichuyuanyin" id="tuichuyuanyin" placeholder="退出原因" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #D4E8D3","margin":"0 0 10px 0","borderColor":"rgba(212, 232, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
