			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="tuichushijian" id="tuichushijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">退出原因：</label>
						<div class="layui-input-block">
							<input v-model="detail.tuichuyuanyin" type="text" :readonly="ro.tuichuyuanyin" name="tuichuyuanyin" id="tuichuyuanyin" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
						  ...
						  carousel.render({
							...
							width: '100%',
						  	...
						  	indicator: 'inside'
                                ...
                                jquery('#tuichushijian').val(getCurDate());
				laydate.render({
					elem: '#tuichushijian'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='tuichushijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tuichushijian = true;
                                                jquery('#tuichushijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='tuichuyuanyin'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tuichuyuanyin = true;
                                                continue;
                                        }
                                        if(o=='zhanghao'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('tuichupintuan/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('tuichupintuan' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
