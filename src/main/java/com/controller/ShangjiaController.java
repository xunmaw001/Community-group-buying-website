...
public class ShangjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShangjiaEntity user = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("shangpubianhao", username));
    ...
    public R register(@RequestBody ShangjiaEntity shangjia){
    	...
    	ShangjiaEntity user = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("shangpubianhao", shangjia.getShangpubianhao()));
		if(user!=null) {
