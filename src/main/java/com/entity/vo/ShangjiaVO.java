...
public class ShangjiaVO  implements Serializable {
	...
	public void setYingyezhenghao(String yingyezhenghao) {
		this.yingyezhenghao = yingyezhenghao;
	}
	
	/**
	 * 获取：营业证号
	 */
	public String getYingyezhenghao() {
		return yingyezhenghao;
	}
